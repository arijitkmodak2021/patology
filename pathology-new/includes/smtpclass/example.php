...
$mail = new KM_Mailer("smtp.gmail.com", "587", "basu.aniket09@gmail.com", "aniketbabai1987", "tls");
...
if(!$mail->send('aniket@esolzmail.com', 'avishek@esolzmail.com', 'test email 4', 'This is a plain text email.'))
{
echo "Failed to send email";
}
else
{
echo "Email sent successfully";
$mail->send('aniket@esolzmail.com', 'aniket@esolzmail.com', 'test email 4', 'This is a plain text email.');
}
?>
